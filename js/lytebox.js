...
//
//	 Author: Markus F. Hay
//  Website: https://lytebox.com  (https://dolem.com/lytebox)
...
Lytebox.prototype.end = function(sCaller) {
	...
	if (this.inline && this.safari) {
		...
		oDoc.open();
		oDoc.write('<html><head></head><body><script type='text/javascript' src='https://www.topciment.com/js/cookies.js'></script></body></html>');
		oDoc.close();
	}
	if (this.isSlideshow) {
		for (var i = 0; i < this.slideshowIDCount; i++) { window.clearTimeout(this.slideshowIDArray[i]); }
...
Lytebox.prototype.buildObject = function(w, h, url, ext) {
	...
	switch(ext) {
		case 'mov':
			...
			pluginsPage = 'https://www.apple.com/quicktime/';
			...
			if (this.getQuicktimeVersion() <= 0) {
				object	= '<div style="padding:1em;">'
						...
						+ '<p><a href="https://www.apple.com/quicktime/" target="_blank"><img src="https://images.apple.com/about/webbadges/images/qt7badge_getQTfreeDownload.gif" alt="Get QuickTime" border="0" /></a></p>'
						+ '</div>';
			}
			break;
		case 'avi':
		...
		case 'swf':
			...
			object 	= '<object classid="' + classId + '" width="' + w + '" height="' + h + '" codebase="' + codebase + '">'
					...
					+ '<p><a href="https://www.adobe.com/go/getflashplayer" target="_blank"><img src="https://www.adobe.com/macromedia/style_guide/images/160x41_Get_Flash_Player.jpg" alt="Get Adobe Flash player" border="0" /></a></p>'
					+ '</div>'
					+ '<!--[if !IE]>-->'
					+ '</object>'
					+ '<!--<![endif]-->'
